...
function PortfolioCatName($cat_id){
    $cat = PortfolioCategoriesTable::getCatNameById($cat_id);
    
    return $cat['pc_name'];
}

function PortfolioRoleName($role_id){
    $role = PortfolioRolesTable::getRoleNameById($role_id);
