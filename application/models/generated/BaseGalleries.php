...
Doctrine_Manager::getInstance()->bindComponent('Galleries', 'default');
 ...
 * @property integer $year_execution
...
abstract class BaseGalleries extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('year_execution', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'fixed' => false,
             'unsigned' => false,
        ...
        $this->hasColumn('my_role', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'unsigned' => false,
    ...
    {
        parent::setUp();
        $this->hasOne('GalleryCategories', array(
             'local' => 'category_id',
             'foreign' => 'id'));
    }
}